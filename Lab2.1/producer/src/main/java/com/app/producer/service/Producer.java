...
import com.app.producer.entity.Bill;
...
public class Producer implements Runnable {
    ...
    public Bill generateData() throws IOException {
        ...
        List<String> list = Files.readAllLines(
                new File("C:\\Users\\User\\Desktop\\FAF\\FAF-sem5\\Network programming (PR)\\" +
                        "Minimum Task\\Lab2.1\\producer\\src\\main\\resources\\static\\serviceProviders.txt")
    ...
    public void sendData(Bill bill){
        ...
        restTemplate.postForObject("http://localhost:8081/producer", requestBody, Bill.class);
    }
}
